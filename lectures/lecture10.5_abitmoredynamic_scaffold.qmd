...
filled.contour(result$conc, xlab = "Time", ylab = "Distance") #good way to vizualize 2d data 
filled.contour(t(result$conc), ylab = "Time", xlab = "Distance") # flip x and y with t() 
...
```{r}
resfast <- diff1(initialC = 200, nx = 10, dx = 0.5, nt = 10, dt = 10, D = 0.08, area = 1)
...
resfast <- diff1(initialC = 100, nx = 10, dx = 0.5, nt = 20, dt = 0.08, D = 1, area = 1)
filled.contour(resfast$conc, xlab = "Time", ylab = "Distance", main = "Concentration through time and space")
filled.contour(resfast$qin, xlab = "Time", ylab = "Distance", main = "Qin")
...
ggplot(resl, 
       aes(time, conc, col=distance)) + geom_line()
