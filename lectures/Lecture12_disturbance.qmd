...
res <- ode(Cinitial, tm, dharvest, gps) # does the numerical intergration for you - runs intergation with timesteps - with respect to one thing (if want integration of 2+ things, use other function)
...
# returns a times series 
getcarbon(Cinitial = 20, 
          tm = seq(from = 1, to = 100), 
          K = 100, 
          r = 0.2, 
          harv = 0.2,
...
# apply this function to all harvest values - each row will be time series 
